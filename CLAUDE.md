...
The user-facing manual is the MkDocs (Material) site under `documentation/docs/` (config `mkdocs.yml`, published to GitHub Pages). Write it the way a professional technical writer would, not the way an AI writes by default.
