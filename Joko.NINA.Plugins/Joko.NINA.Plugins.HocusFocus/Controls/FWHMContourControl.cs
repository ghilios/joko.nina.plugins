    ...
    public class FWHMContourControl : ILNSceneControlBase {
        ...
        protected override Scene GetScene() {
            ...
            using (Scope.Enter()) {
                ...
                var contourPlot = new ContourPlot(points, colormap: colormap, create3D: true, lineWidth: 1, showLabels: true);
                var contourSurface = new Surface(points, colormap: colormap) {
