...
namespace NINA.Joko.Plugins.HocusFocus.Interfaces {
    ...
    public class StarDetectorParams {
        ...
        // Set <= 0 to disable and fall back to the R² gate.
        public double PSFGoodnessOfFitChiSqThreshold { get; set; } = 2.0;
