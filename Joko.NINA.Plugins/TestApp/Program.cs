        ...
        private static async Task Main(string[] args) {
            ...
            */
            ...
            using (var stopwatch = MultiStopWatch.Measure()) {
                ...
                var solution = nlSolver.Solve(sensorModelSolver);
                var goodnessOfFit = nlSolver.GoodnessOfFit(sensorModelSolver, solution);
                Console.WriteLine($"Solved fit: {solution}. GoF = {goodnessOfFit:0.0000}");
                ...
                Console.WriteLine($"Solved IRLS fit: {solution2}. GoF = {goodnessOfFit2:0.0000}");
