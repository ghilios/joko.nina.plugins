...
| **Outlier Rejection Confidence** (entered as a percentage) | 0.90 | > 0.5, < 1.0 | "Confidence level for a two-tailed Grubbs statistical test of outliers to use during Auto Focus curve fitting. 90% is a reasonable default. Must be above 50% and below 100%." |
